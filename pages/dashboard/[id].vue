...
<template>
    <div class="relative flex size-full min-h-screen flex-col bg-[#020618] dark group/design-root overflow-x-hidden"
                ...
                <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
                    ...
                    <div class="pb-3">
                        <div class="flex border-b border-[#416039] px-4 gap-8">
                            <a class="flex flex-col items-center justify-center pb-[13px] pt-4" :class="{
                            ...
                            }" href="#" @click.prevent="changeTab('overview')">
                            ...
                            }" href="#" @click.prevent="changeTab('products')">
                            ...
                            }" href="#" @click.prevent="changeTab('reviews')">
                    ...
                    <template v-if="activeTab === 'overview'">
                        ...
                        <p class="text-[#a1c398] px-4">This section would contain more details about the business
                            overview.</p>
                    </template>
